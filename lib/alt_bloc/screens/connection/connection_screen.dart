...
class ChatConnectionScreen {
  static Route route(Contact contact) {
    return MaterialPageRoute(builder: (_) {
      return _ConnectionLayout(Icons.chat, 'Chat request to ${contact.name}');
    });
  }
}

class CallConnectionScreen {
  static Route route(Contact contact) {
    return MaterialPageRoute(builder: (_) {
      return _ConnectionLayout(Icons.call, 'Call to ${contact.name}');
    });
  }
}

class _ConnectionLayout extends StatelessWidget {
  const _ConnectionLayout(this._iconData, this._label, {Key key}) : super(key: key);
